...
import { arrayoffers } from "../constants";
import OfferDetails from "../features/offers/components/OfferDetails";
import OfferSkeleton from "../features/offers/components/OfferSkeleton";
import ParnterCard from "../features/offers/components/ParnterCard";
import OfferCard from "../features/offers/components/OfferCard";
import { useScrollToElement } from "../hooks/useScrollToElement";
import { useSearchParams } from "react-router-dom";
import FilterByDeviceMenu from "../features/offers/components/FilterByDeviceMenu";
import FilterByPopularityMenu from "../features/offers/components/FilterByPopularityMenu";
import { cn } from "../utils";
import SearchBar from "../features/search/components/SearchBar";
import Spinner from "../components/Shared/Spinner";
import Empty from "../components/Shared/Empty";
import { selectSidebarCollapsed } from "../context/appStateSlice";
import { useInfiniteOffers } from "../features/offers/hooks";
import { IFilterByDevice, IFilterByPopularity } from "../features/offers/types";
...
const Offers = () => {
  ...
  const { status, data, error, isFetchingNextPage, fetchNextPage, hasNextPage, isFetchNextPageError } =
    useInfiniteOffers({ filterByDevice, filterByPopularity, limitPerPage });
