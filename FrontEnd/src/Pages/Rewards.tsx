      ...
      <div className="flex flex-col items-start justify-between gap-6 bg-[#242438] px-4 md:flex-row md:items-center md:px-6">
        ...
        >
          <span
            ...
            } absolute left-0 top-0 flex h-full items-center justify-between rounded-md bg-[#4e3636] text-[#8792fa]`}
          >
            {bonusCode?.code}
          ...
          <span id="bonus-code" className="w-[120px] text-white">
            {loading ? (
              <Spinner className="mx-auto h-6 w-6 border-[3px] border-b-blue-800 border-l-blue-800" />
            ) : (
              t("Bonus Code")
            )}
          </span>
