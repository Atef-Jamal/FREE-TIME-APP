...
import { handleSendTestimonial } from "../features/home/services";
import { handleSignInWithOauth, login } from "../features/auth/services";
import { useFetchTestimonials } from "../features/home/hooks";
import { authSchema } from "../lib/zod";
import { addTestimonialCache } from "../features/home/cache";
import "swiper/css";
...
const Home = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (newTestimonial) => {
      setComment("");
      addTestimonialCache({ queryClient, newTestimonial });
    },
  });
