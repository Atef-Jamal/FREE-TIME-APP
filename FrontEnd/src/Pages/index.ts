...
export const PublicUserProfile = lazy(() => import("./UserProfile"));
export const Offers = lazy(() => import("./Offers"));
...
export const MobileChat = lazy(() => import("../features/chats/public-chat/components/MobileChat"));
