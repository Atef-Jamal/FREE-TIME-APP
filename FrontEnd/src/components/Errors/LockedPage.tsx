  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div className="flex flex-col items-center justify-center mx-3">
        ...
        <div className="mb-5">
          <p className="text-[#95aeb9] text-3xl sm:text-2xl font-bold tracking-wide">Protected Page</p>
          <p className="text-[#95aeb9] text-3xl sm:text-2xl font-bold tracking-wide">Sign in to view</p>
        </div>
