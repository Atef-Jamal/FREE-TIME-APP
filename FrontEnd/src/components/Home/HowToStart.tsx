    ...
    <div className="">
      ...
      <div className="w-[90%] mx-auto flex items-center justify-around sm:flex-col gap-7">
        <div className="w-[420px] h-[180px] lg:w-[320px] lg:h-[160px] sm:w-[70%] xs:w-full bg-[#4346745e] rounded-md relative ">
          <span className="text-5xl font-bold text-yellow-300 absolute top-[-12%] left-[6%]">01</span>
          <p className="text-sm font-bold ml-8 mt-8 text-white blur-sm">This text have some Blure</p>
          <p className="text-xs  ml-8 mt-2 text-white blur-sm">This text have some Blure again</p>
          ...
          <div className=" bg-[#241c38d3] w-[90%] h-[90%] absolute top-[6%] left-[5%] rounded-md flex flex-col items-center overflow-hidden opacity-[0.6]">
            <h1 className="font-bold tracking-wider text-center text-yellow-300 ">{t("Choose a Task")}</h1>
            <div className="w-[90%] h-9 mt-1 flex justify-between p-2 rounded-lg bg-[#5c46aa80]">
              ...
              <button className=" rounded-md bg-[#120d3863] px-2 border-t text-white text-sm">$69.00</button>
            </div>
        ...
        <div className="w-[420px] h-[180px] lg:w-[320px] lg:h-[160px] sm:w-[70%] xs:w-full bg-[#4346745e] rounded-md relative ">
          <span className="text-5xl font-bold text-yellow-300 absolute top-[-12%] left-[6%] ">02</span>
      ...
      <div className="w-[90%] flex items-center justify-center mx-auto">
        <div className="w-[420px] h-[180px] lg:w-[320px] lg:h-[160px] sm:w-[70%] xs:w-full bg-[#4346745e] rounded-md relative mx-auto mt-16 sm:mt-7 ">
          <span className="text-5xl font-bold text-yellow-300 absolute top-[-12%] left-[6%]">03</span>
          <div className="m-auto bg-[#130f1fbb] w-[90%] h-[90%] absolute top-[6%] left-[5%] rounded-md flex flex-col items-center overflow-hidden opacity-[0.6]  sm:w-[90%] sm:pl-8">
            ...
            <img alt={""} src={moneyHome} className="absolute w-36 h-36 left-[-20px] top-5 " />
            <p className="text-white mb-2">{t("And Cash Them Out")}</p>
