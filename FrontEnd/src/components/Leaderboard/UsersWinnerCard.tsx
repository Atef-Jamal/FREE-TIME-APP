...
const UsersWinnerCard = ({ user, index }: TypeProps) => {
  return (
    <div
      ...
      className={`relative flex flex-col items-center justify-center rounded-md py-10 ${
        index === 0
          ? "bg-gradient-to-b from-[#69ff054b] to-[#1e29169c]"
          : "bg-gradient-to-b from-[#494957] to-[#222230]"
      } w-[85%] border-t-[1px] pb-5 before:absolute before:left-0 before:top-1 before:h-[100%] before:w-[1.3px] before:bg-gradient-to-b before:from-slate-100 before:to-slate-900 after:absolute after:right-0 after:top-1 after:h-[100%] after:w-[1.3px] after:bg-gradient-to-b after:from-slate-100 after:to-slate-900 sm:w-[280px]`}
    >
      ...
      <div
        className={`relative mx-auto h-[200px] w-[85%] rounded-md border-t-[0.5px] bg-gradient-to-b from-[#1F1F30] to-[#1f1f3073] before:absolute before:left-0 before:top-0 before:h-[100%] before:w-[1.3px] before:bg-gradient-to-b before:from-slate-100 before:to-slate-900 after:absolute after:right-0 after:top-0 after:h-[100%] after:w-[1.3px] after:bg-gradient-to-b after:from-slate-100 after:to-slate-900`}
      >
      ...
      <span
        className={`absolute bottom-4 left-[-3%] flex flex-col border-t-2 ${
          index === 0 ? "bg-[#1ae62b]" : undefined
        } ${index === 1 ? "bg-[#838592]" : undefined} ${
          index === 2 ? "bg-[#838592]" : undefined
        } overflow-hidden rounded-[5px] px-4 text-sm font-bold text-white md:text-2xl`}
      >
        {index === 0 && "1ND"}
        {index === 1 && "2ST"}
        {index === 2 && "3ND"}
